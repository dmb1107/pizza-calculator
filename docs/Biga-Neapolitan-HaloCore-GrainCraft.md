...
- **No diastatic malt.** At 800–900 °F on the Tread, added sugars and extra amylase just burn. Grain Craft is unmalted, and that's correct here.

---

## 3. Batch tables

Flour scales in clean 470 g units. Each includes ~2.2% overage for bowl residue and scrap.

| Balls | Total flour | **BIGA:** flour | water | ADY* | **FINAL:** flour | water | salt | Dough out | Balls @265 g |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 3 | 470.0 | 305.5 | 152.8 | 1.15 | 164.5 | 176.2 | 13.2 | 812 g | 795 g |
| 6 | 940.0 | 611.0 | 305.5 | 2.29 | 329.0 | 352.5 | 26.3 | 1624 g | 1590 g |
| 9 | 1410.0 | 916.5 | 458.2 | 3.44 | 493.5 | 528.7 | 39.5 | 2437 g | 2385 g |

\* ADY at **0.38% of biga flour** — the Giorilli standard (= 1% fresh = 0.30% IDY). See §5.

### Scaling to any batch — the arithmetic

The tables cover 3/6/9/12/18 at 265 g. For anything else — a different ball weight, 5 balls, 7 balls — run this. It's six lines and it's all the recipe needs.

**Start:** `F = (balls × ball weight × 1.022) ÷ 1.728`

| | Formula | Check at 9 × 265 g |
|---|---|---|
| Total flour | `F` | 1410 g |
| Biga flour | `F × 0.65` | 916.5 g |
| Biga water | `F × 0.325` | 458.2 g |
| Biga ADY | `F × 0.00247` | 3.44 g |
| Final-mix flour | `F × 0.35` | 493.5 g |
| Final-mix water | `F × 0.375` | 528.7 g |
| Salt | `F × 0.028` | 39.5 g |

Where the constants come from: **1.728** is the dough yield factor (1 + 0.70 water + 0.028 salt), **1.022** is the 2.2% overage. Biga water is 0.65 × 0.50; final water is 0.70 − 0.325; ADY is 0.65 × 0.0038.
...
|---|---|---|
| **12** | **One biga**: 1222 g flour + 611 g water + 4.58 g ADY (1833 g) — fits | Split biga into **2 × 916.5 g**, run **two 6-ball final mixes** |
| **18** | **Two bigas**, each the 9-ball spec (1375 g) — 1833 g of biga flour exceeds the low-hydration cap | **Two 9-ball final mixes** |

### Note on small batches
...
The 3-ball **final dough** is 812 g, above the 500 g minimum but near it; expect some hook climb.
...
> ### **1% fresh yeast = 0.30% IDY = 0.38% ADY, on biga flour**
...
| Balls | Biga flour | **ADY @ 0.38%** | (IDY @ 0.30%) |
|---:|---:|---:|---:|
| 3 | 305.5 g | **1.15 g** | 0.92 g |
| 6 | 611.0 g | **2.29 g** | 1.83 g |
| 9 | 916.5 g | **3.44 g** | 2.75 g |
| 12 | 1222.0 g | **4.58 g** | 3.67 g |
...
Method: water and yeast into a wide, deep container, mix to dissolve. Add flour. Make a claw with your hand and circulate fingertips through it. **3–6 minutes, until no dry flour remains** — any dry flour never ferments. Break up any large chunks by hand.
...
3. Water and ADY into a wide, deep container. Stir to dissolve. Add the flour.
...
**Why DDT − 4 and not DDT.** At the end of Phase B you have absorbed roughly two thirds of the total friction — Phases A and B are long, and the hydration exotherm has already fired. Still to come: Phase C (+3.8 °F), Phase D (+0.9 °F), minus about 1 °F given back to the room during the 10-minute rest. Net **+3.7 °F**, so aim about 4 °F low.
...
**Phase C has limited authority, and this is the important part.** Cutting it to 2 min only saves 1.6 °F; stretching it to 5.5 min only adds 2.2 °F. Outside that window you are trading gluten development for temperature and losing both — an under-mixed dough at the right temperature is worse than a properly developed one that is 2 °F warm. Temperature misses get fixed upstream in the water calculation, not downstream by mangling the mix.

**Friction per minute at each speed**, if you need to correct in a different phase: 15% ≈ 0.75 °F/min · 20% ≈ 0.86 °F/min · 30% ≈ 1.08 °F/min.
...
BIGA 65% @ 50% hyd  ·  TOTAL HYD 70%  ·  SALT 2.8%  ·  265 g BALLS  ·  DY 1.728
           ...
           TOTAL   BIGA-f  BIGA-w   ADY*   FIN-f   FIN-w   SALT
 3 balls    470     305.5   152.8   1.15   164.5   176.2   13.2
 6 balls    940     611.0   305.5   2.29   329.0   352.5   26.3
 9 balls   1410     916.5   458.2   3.44   493.5   528.7   39.5
 12 = one 1222 g-flour biga, split, 2 x 6-ball mixes
 18 = two 9-ball bigas, 2 x 9-ball mixes
 *ADY 0.38% of biga flour (= 1% fresh = 0.30% IDY), Giorilli standard.
