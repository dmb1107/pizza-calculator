...
weights**, the ice calculation removed, and **MESSAGE-32 applied**. Left: the
...
- [x] Emulated phone audit of the live site, 24 September (375 px, touch,
      ...
      12 → 14 px.
- [x] The speed indicator's geometry, from Dave (25 Sep): twelve 30° positions
      round the knob, the bottom two missing; the first segment just left of
